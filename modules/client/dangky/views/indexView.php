<?php get_header('', 'Đăng ký tài khoản') ?>
<style>
    *{
    padding: 0px;
    margin: 0px;
...
.form-ques a{
    ...
    <div class="container-signin">
        <div class="signin">
            <form action="" class="form-signin-main" method="POST">
                <div class="form-signin">
                    <img src="public/image/logo.jpg" alt="">
                    <h1>ĐĂNG <span style="color:#cd8f5c ;">KÝ</span></h1>
                    <div class="form-group">
                        <input type="text" placeholder="Họ và tên" name="name_users" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" placeholder="Mật khẩu" name="pw_users" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" placeholder="Địa chỉ email" name="email_users" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" placeholder="Địa chỉ" name="address_users" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" placeholder="Số điện thoại" name="phone_users"required>
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-ques">
                        ...
                        <a href="?role=client&mod=auth">Đăng nhập</a>
                    </div>
                    <br>
                </div>
            </form>
