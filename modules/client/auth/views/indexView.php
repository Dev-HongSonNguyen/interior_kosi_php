<?php get_header('', 'Đăng nhập tài khoản') ?>
<style>
    *{
    padding: 0px;
    margin: 0px;
...
<div class="container-signin">
        <div class="signin">
            <form action="" class="form_signin_main" method="POST">
                <div class="form-signin">
                    <img src="public/image/logo.jpg" alt="">
                    <h1>ĐĂNG <span style="color:#cd8f5c ;">NHẬP</span></h1>
                    <div class="form-group">
                        <input type="text" placeholder="Địa chỉ email" name="email_users">
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="password" placeholder="Mật khẩu" name="pw_users">
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-ques qmk">
                        <a href="?role=client&mod=auth&action=forgot_password">Quên mật khẩu</a>
                    </div>
                    <div class="form-ques">
                        <span>Bạn chưa có tài khoản ?</span>
                        <a href="?role=client&mod=dangky">Đăng ký</a>
                    </div>
                    <br>
                </div>
            </form>
