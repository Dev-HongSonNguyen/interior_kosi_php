        ...
        <div class="acount-mng">
                ...
                <div class="block-infor">
                    ...
                    if(is_auth()){
                        ...
                        <p><strong>XIN CHÀO ! </strong><br>
                            <?php echo $_SESSION['auth']['name_users'] ?></p>
                        <?php
                    }
                    ?>
            ...
            <div class="acount-mng-right">
                <div class="acount-mng-right-top">
                    ...
                    <a href="?role=client&mod=users&action=update&id_users=<?php echo $_SESSION['auth']['id_users'] ?>">Sửa thông tin</a>
                </div>
                <div class="acount-mng-right-bottom">
                    <?php
                    if(is_auth()){
                        ?>
                        <p>Họ tên : <?php echo $_SESSION['auth']['name_users'] ?></p>
                        <p>Địa chỉ email: <?php echo $_SESSION['auth']['email_users'] ?></p>
                    <?php
                    }
                    ?>
                </div>
